...
@Component({
  selector: 'app-product-items-mens',
  templateUrl: './product-items-mens.component.html',
  styleUrls: ['./product-items-mens.component.css']
})
export class ProductItemsMensComponent implements OnInit {
