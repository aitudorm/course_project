...
@Component({
  selector: 'app-product-cart-access',
  templateUrl: './product-cart-access.component.html',
  styleUrls: ['./product-cart-access.component.css']
})
export class ProductCartAccessComponent implements OnInit, DoCheck {
