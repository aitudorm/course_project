...
@Component({
  selector: 'app-product-items-access',
  templateUrl: './product-items-access.component.html',
  styleUrls: ['./product-items-access.component.css']
})
export class ProductItemsAccessComponent implements OnInit {
