...
@Component({
  selector: 'app-product-list-access',
  templateUrl: './product-list-access.component.html',
  styleUrls: ['./product-list-access.component.css']
})
export class ProductListAccessComponent implements OnInit {
  ...
  constructor(private productRetrieveService : ProductRetrieveService,
    ...
    async ngOnInit() {
      this.productRetrieveService.retrieveAccess().subscribe(
        result => {
